...
def get_data(data_dir):
    ...
    for dialog_filename in dialog_filenames:
        dialog_filename_list = dialog_filename.split("/")
        dialog_filename_file = dialog_filename_list[len(dialog_filename_list) - 1]
        yield get_utterances_from_filename(dialog_filename), dialog_filename_file
